...
$params = array_merge( array(
		...
		'form_title_text'      => T_('Leave a Reply'),
		'form_comment_text'    => T_('Comment'),
		'form_submit_text'     => T_('Post comment'),
...
/* ]]> *
	...
	{ // User is logged in and activated:
		$Form->info_field( T_('User'), '<br/><strong class="form_current_user">'.$current_User->get_identity_link( array(
